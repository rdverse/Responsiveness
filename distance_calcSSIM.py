...
def get_euclidean(personID, frames,keypointNo, col_x, col_y):
        ...
        if frame in frames:
            ...
            if frames[pos] - frames[pos - 1] == 1:
                ...
                try:
                    ...
                    cap = cv2.VideoCapture("test3.MTS")
    ...
    DISTANCES_TRACK[str(personID) + '_' + keypointNo + '_' PanopticSegmentation/panoptic_fpn_R_101_3x/139514519/model_final_cafdb1.pkl+ 'r'] = distances_r
